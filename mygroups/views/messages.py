...
def message_list(request, pk, topic_id, template_name='groups/messages/message_list.html'):
    """
...
def message_detail(request, pk, topic_id, message_id,
...
@membership_required
def message_create(request, pk, topic_id,
...
@membership_required
def message_edit(request, pk, topic_id, message_id,
        template_name='groups/messages/message_form.html'):
    """
...
@membership_required
def message_remove(request, pk, topic_id, message_id,
