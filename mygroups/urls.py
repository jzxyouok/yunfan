...
GROUP_URL = r'(?P<pk>[-\w]+)/'  #use for point group,slug is unique
...
urlpatterns = patterns('mygroups.views.groups',
...
#GROUP_URL: P<slug>
#PAGE_URL:  P<slug>/pages/P<page_slug>
#TOPIC_URL: P<slug>/topics/P<topic_id>
#MESSAGE_URL:P<slug>/messages/P<message_id>

# Topics
urlpatterns += patterns('mygroups.views.topics',
...
# Pages
urlpatterns += patterns('mygroups.views.pages',
...
# Messages
urlpatterns += patterns('mygroups.views.messages',
