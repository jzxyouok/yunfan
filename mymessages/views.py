...
from mymessages.models import Message, TO_STATUS_READ, TO_STATUS_DELETED, FROM_STATUS_DELETED
from mymessages.forms import MessageForm
from mytools.baseconv import base62
...
def message_create(request, content_type_id=None, object_id=None, 
    ...
    if form.is_valid():
        ...
        message = form.save()
        return HttpResponseRedirect(next or reverse('messages'))
    return render_to_response(template_name, {
        'form': form,
        'to_user': to_user,
